...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_ortho_4x12(KC_TAB, KC_SLSH, KC_BSLS, KC_LPRN, KC_RPRN, KC_HOME, KC_PGUP, KC_AMPR, KC_ASTR, KC_TILD, KC_EQL, KC_BSPC, KC_ESC, KC_LT, KC_GT, KC_LBRC, KC_RBRC, KC_END, KC_PGDN, KC_DLR, KC_PERC, KC_CIRC, KC_UNDS, KC_NO, KC_LSFT, KC_PIPE, KC_PIPE, KC_LCBR, KC_RCBR, KC_INS, KC_DEL, KC_EXLM, KC_AT, KC_HASH, KC_PMNS, KC_ENT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_SPC, KC_SPC, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
